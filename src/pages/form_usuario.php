    ...
    <div class="form-container">
      ...
      <form action="../usuario/insert_usuario.php" method="POST" class="usuario-form">
        ...
        <div class="form-group">
          ...
          <input type="email" id="email" name="email" maxlength="100" required value="<?php echo isset($email) ? $email : ""; ?>" placeholder="email@exemplo.com">
        </div>

        <div class="form-group">
          <label for="senha">Senha*</label>
          <input type="password" id="senha" name="senha" maxlength="100" required value="<?php echo isset($senha) ? $senha : ""; ?>" placeholder="Digite a senha">
        </div>
